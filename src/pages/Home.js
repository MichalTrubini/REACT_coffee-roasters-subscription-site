    ...
    <main>
      ...
      <section className="highlights margin-fix">
        <div className="highlights__intro">
            ...
            <p className="highlights__text">A large part of our role is choosing which particular coffees will be featured in our range. This means working closely with the best coffee growers to give you a more impactful experience on every level.</p>
        </div>
        <div className="highlights__items">
            {highlights.map(item => 
                <div className="highlights__item" key={item.title}>
                    <img className="highlights__item-img" src={item.img} alt={item.title}/>
      ...
      <section className="steps__home">
        ...
        <Steps classNameSteps='steps__margin-fix' classNameHeader='steps__item-title-dark' classNamePar='steps__item-text-dark'/>
